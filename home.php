...
function searchCinemas($query){
    ...
    $url = "https://maps.googleapis.com/maps/api/place/textsearch/json?type=movie_theater&query={$query}&key=AIzaSyBkTndwMBrpCv9TQg1EUQbghII3jtVShL4";
